...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<SystemArticleApi.SystemArticle>,
});

function onActionClick(e: OnActionClickParams<SystemArticleApi.SystemArticle>) {
  switch (e.code) {
    case 'delete': {
      onDelete(e.row);
      break;
...
async function onStatusChange(
  newStatus: number,
  row: SystemArticleApi.SystemArticle,
) {
...
function onEdit(row: SystemArticleApi.SystemArticle) {
